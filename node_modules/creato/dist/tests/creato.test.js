...
describe('bin', () => {
    ...
    test('returns on existing directory and no force', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('overrides directory on force', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('logs success on success', () => __awaiter(void 0, void 0, void 0, function* () {
        const dist = path.resolve(__dirname, 'folder');
        /**
         * Mocks
         */
    ...
    test('warns error on error', () => __awaiter(void 0, void 0, void 0, function* () {
        const dist = path.resolve(__dirname, 'folder');
        /**
         * Mocks
         */
